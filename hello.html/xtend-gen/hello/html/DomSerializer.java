...
public class DomSerializer {
  public CharSequence serialize(final Node n) {
  ...
  private String applyContents(final Node n) {
    List<Node> _contents = n.getContents();
    final Function1<Node,CharSequence> _function = new Function1<Node,CharSequence>() {
        public CharSequence apply(final Node x) {
          CharSequence _serialize = DomSerializer.this.serialize(x);
          return _serialize;
        }
      };
